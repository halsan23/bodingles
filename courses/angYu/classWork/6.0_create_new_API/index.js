...
// jokes ARRAY - each object is an item in the array - jokes[0] to jokes[99]
const jokes = [
  {
    id: 1,
    jokeText:
...
app.get("/random", (req, res) => {
   ...
   // res.json converts the Js object into a Json object
   res.json(jokes[jokeNumber]);
});

//Get a specific joke
app.get("/jokes/:id", (req, res) => {
   // id is returned as a string - convert to integer
   const id = parseInt(req.params.id);
   // use Js 'find' method to find match using callback function - if joke.id exactly matches entered id
